...
func testGet(t *testing.T, c *Config, section string, option string, expected interface{}) {
	ok := false
...
// TestInMemory creates configuration representation and runs multiple tests in-memory.
